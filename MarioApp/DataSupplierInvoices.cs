            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(cnn))
            {
                try
                {
                    ...
                    while (readerNew.Read())
                    {
                        ...
                        string supplierId;
                        supplierId = readerNew["v034"].ToString().Trim(' ');


                        supplierInvoicesNew.Add(new VsoftSupplierInvoice
                        {
                            // RvID = (int)readerNew["rvID"],
                            // A110 = supplierId.Substring(1),
                            VsoftSupplierId = supplierId.Substring(1).Trim(' '),
                    ...
                    try
                    {                        
                        connection.Execute("spVsoftSupplierInvoices_InsertFull @Id, @V035, @V066, @V036, @V037, @V038, @V249, @Decv249, @V039, @Vs03, @V040, @Decv040, @V041, @V245, @V246, @RvDm, @BstndNaam37, @TypeZending37, @BstBlob37, @V042, @V043, @V044, @V045, @V046, @V047, @V048, @V049, @V050, @V051, @V052, @V053, @V054, @Decv042, @Decv043, @Decv044, @Decv045, @Decv046, @Decv047, @Decv048, @Decv049, @Decv050, @Decv051, @Decv052, @Decv053, @Decv054, @VsoftSupplierId", supplierInvoicesNew);
                    }
                    catch (Exception)
                    {
                        throw;
                    ...
                    while (readerUpdate.Read())
                    {
                        ...
                        string supplierId;
                        supplierId = readerUpdate["v034"].ToString().Trim(' ');
                    ...
                    try
                    {
                        connection.Execute("spVsoftSupplierInvoices_UpdateFull @Id, @V035, @V066, @V036, @V037, @V038, @V249, @Decv249, @V039, @Vs03, @V040, @Decv040, @V041, @V245, @V246, @RvDm, @BstndNaam37, @TypeZending37, @BstBlob37, @V042, @V043, @V044, @V045, @V046, @V047, @V048, @V049, @V050, @V051, @V052, @V053, @V054, @Decv042, @Decv043, @Decv044, @Decv045, @Decv046, @Decv047, @Decv048, @Decv049, @Decv050, @Decv051, @Decv052, @Decv053, @Decv054, @VsoftSupplierId", supplierInvoicesUpdate);
                    }
                    catch (Exception)
                    {
                        throw;
