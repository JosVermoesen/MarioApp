            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(cnn))
            {
                try
                {
                    ...
                    while (readerNew.Read())
                    {
                        ...
                        string clientId;
                        clientId = readerNew["v034"].ToString().Trim(' ');


                        customerInvoicesNew.Add(new VsoftCustomerInvoice
                        {
                            // RvID = (int)readerNew["rvID"],
                            // A110 = clientId.Substring(1),
                            VsoftCustomerId = clientId.Substring(1).Trim(' '),

                            Id = readerNew["v033"].ToString().Trim(' '),
                    ...
                    try
                    {
                        ...
                        connection.Execute("spVsoftCustomerInvoices_InsertFull @Id, @V035, @V066, @V036, @V037, @V038, @V249, @Decv249, @V039, @Vs03, @V040, @Decv040, @V041, @V245, @V246, @A000, @B010, @DecB010, @B014, @DecB014, @B090, @DecB090, @B094, @DecB094, @V065, @Decv065, @E069, @Dece069, @E071, @E072, @V055, @Decv055, @V056, @Decv056, @V057, @Decv057, @V058, @Decv058, @V059, @Decv059, @V060, @Decv060, @V061, @Decv061, @V062, @Decv062, @V063, @Decv063, @V064, @Decv064, @RvDm, @BstndNaam37, @TypeZending37, @BstBlob37, @RvXmltb2, @VsoftCustomerId", customerInvoicesNew);
                    }
                    catch (Exception)
                    {
                        throw;
                    ...
                    while (readerUpdate.Read())
                    {
                        ...
                        string clientId;
                        clientId = readerUpdate["v034"].ToString().Trim(' ');
                        ...
                        customerInvoicesUpdate.Add(new VsoftCustomerInvoice 
                        {
                            ...
                            Id = readerUpdate["v033"].ToString().Trim(' '),
                    ...
                    {
                        // connection.Execute("dbo.spVsoftCustomers_InsertFull @Id, @A107, @A108, @A100", customers);                    
                        connection.Execute("spVsoftCustomerInvoices_UpdateFull @Id, @V035, @V066, @V036, @V037, @V038, @V249, @Decv249, @V039, @Vs03, @V040, @Decv040, @V041, @V245, @V246, @A000, @B010, @DecB010, @B014, @DecB014, @B090, @DecB090, @B094, @DecB094, @V065, @Decv065, @E069, @Dece069, @E071, @E072, @V055, @Decv055, @V056, @Decv056, @V057, @Decv057, @V058, @Decv058, @V059, @Decv059, @V060, @Decv060, @V061, @Decv061, @V062, @Decv062, @V063, @Decv063, @V064, @Decv064, @RvDm, @BstndNaam37, @TypeZending37, @BstBlob37, @RvXmltb2, @VsoftCustomerId", customerInvoicesUpdate);
                    }
                    catch (Exception)
                    {
                        throw;
